...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Playwrite+IN:wght@100..400&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <div x-data="{ showSidebar: false }" class="relative flex w-full flex-col md:flex-row">
            ...
            <div class="flex flex-col gap-2 overflow-y-auto pb-6">
                ...
                <div x-data="{ isExpanded: false }" class="flex flex-col">
                    <button type="button" x-on:click="isExpanded = ! isExpanded" id="user-management-btn"
                        ...
                        <span class="mr-auto text-left">Cuti Management</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                    ...
                    <ul x-cloak x-collapse x-show="isExpanded" aria-labelledby="user-management-btn"
                        ...
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="{{ route('page.format.cuti') }}" class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm text-neutral-600 underline-offset-2 
                                    hover:bg-black/5 hover:text-neutral-900 focus:outline-none
                                     focus-visible:underline dark:text-neutral-300 dark:hover:bg-white/5
                                      dark:hover:text-white">Format Cuti</a>
                        </li>
                        <li class="px-1 py-0.5 first:mt-2">
                            <a href="{{ route('page.pengajuan.cuti', Auth::user()->name) }}" class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm
                                     text-neutral-600 underline-offset-2 hover:bg-black/5
                                      hover:text-neutral-900 focus:outline-none focus-visible:underline
                                       dark:text-neutral-300 dark:hover:bg-white/5 
                                       dark:hover:text-white">Pengajuan Cuti
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <a href="{{ route('pengajuan.cutiper.user', Auth::user()->id) }}"
                    class="flex items-center rounded-md gap-2 px-2 py-1.5 text-sm font-medium text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus-visible:underline focus:outline-none dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                        class="size-5 shrink-0" aria-hidden="true">
                        <path
                ...
                <div x-data="{ isExpanded: false }" class="flex flex-col">
                    <button type="button" x-on:click="isExpanded = ! isExpanded" id="user-management-btn"
                        ...
                        <span class="mr-auto text-left">Cuti</span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                            class="size-5 transition-transform rotate-0 shrink-0"
                            x-bind:class="isExpanded ? 'rotate-180' : 'rotate-0'" aria-hidden="true">
                            <path fill-rule="evenodd"
            ...
            <div x-data="{ menuIsOpen: false }" class="mt-auto" x-on:keydown.esc.window="menuIsOpen = false">
                <button type="button"
                    ...
                    <div class="flex flex-col">
                        <span class="text-sm font-bold text-neutral-900 dark:text-white"></span>
                        <span class="w-32 overflow-hidden text-ellipsis text-base font-semibold md:w-36 "
                            aria-hidden="true">{{
                            Auth::user()->name }}</span>
                ...
                <div x-cloak x-show="menuIsOpen"
                    ...
                    <div class="flex flex-col py-1.5">
                        ...
                        <div class="flex flex-col py-1.5 gap-5 w-">
                            <a href="#"
                                class="flex items-center gap-2 px-2 py-1.5 text-sm font-medium text-neutral-600 underline-offset-2 hover:bg-black/5 hover:text-neutral-900 focus-visible:underline focus:outline-none dark:text-neutral-300 dark:hover:bg-white/5 dark:hover:text-white"
                                role="menuitem">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                                ...
                                <form action="{{ route('post.logout') }}" method="POST">
                                    @csrf
                                    @method('post')
                                    <button class="mt-3 w-6/4 pl-5">Sign Out</button>
                                </form>
                            </a>
                        </div>
        ...
        <!-- main content  -->
        <div id="main-content" class="font-poppins h-svh w-full overflow-y-auto p-4 bg-white dark:bg-neutral-950">
